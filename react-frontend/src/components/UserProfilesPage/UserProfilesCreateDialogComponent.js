...
const UserProfilesCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create User Profile" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="userProfiles-create-dialog-component">
            <div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="name">name:</label>
                <p id="name" className="m-0"  >name:</p>
            </span>
            </div>
